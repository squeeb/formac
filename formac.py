...
parser.add_argument(
    "-l", "--lowercase", help="Make output lowercase", action="store_true"
)
parser.add_argument(
    "-g", "--group", type=int, choices=[2, 4], help="Byte grouping size"
)
parser.add_argument(
    "-s",
    "--seperator",
...
parser.add_argument(
    ...
    dest="cisco",
    action="store_true",
    help="Shortcut to --group 4 --seperator .",
)
